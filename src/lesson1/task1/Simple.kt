 ...
 */
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int = 60 * hoursArrive - 60 * hoursDepart - minutesDepart + minutesArrive
...
fun numberRevert(number: Int): Int {
    ...
    val decimals = (number % 100) / 10
    val numbers = number % 10
    return numbers * 100 + decimals * 10 + hundreds
}
